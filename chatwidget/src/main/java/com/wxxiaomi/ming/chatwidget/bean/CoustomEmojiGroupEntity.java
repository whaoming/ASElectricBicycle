 ...
 *
 */
public class CoustomEmojiGroupEntity {
	/**
     * 表情数据
     */
    ...
    public CoustomEmojiGroupEntity(){}
    
    public CoustomEmojiGroupEntity(int icon, List<Emojicon> emojiconList){
        this.icon = icon;
        this.emojiconList = emojiconList;
        type = Emojicon.Type.NORMAL;
    }
    
    public CoustomEmojiGroupEntity(int icon, List<Emojicon> emojiconList, Emojicon.Type type){
        this.icon = icon;
        this.emojiconList = emojiconList;
        this.type = type;
    }
