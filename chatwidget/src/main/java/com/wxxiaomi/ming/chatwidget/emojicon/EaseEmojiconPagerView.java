...
import com.wxxiaomi.ming.chatwidget.emojicon.adapter.EmojiconGridAdapter;
import com.wxxiaomi.ming.chatwidget.emojicon.adapter.EmojiconPagerAdapter;
...
public class EaseEmojiconPagerView extends ViewPager{
    ...
    private List<CoustomEmojiGroupEntity> groupEntities;
	...
	public void init(List<CoustomEmojiGroupEntity> emojiconGroupList, int emijiconColumns, int bigEmojiconColumns){
        ...
        for(int i = 0; i < groupEntities.size(); i++){
            CoustomEmojiGroupEntity group = groupEntities.get(i);
     ...
     * @return
     */
    public List<View> getGroupGridViews(CoustomEmojiGroupEntity groupEntity){
        ...
        for(int i = 0; i < pageSize; i++){
            View view = View.inflate(context, R.layout.ming_expression_gridview, null);
     ...
     * @param groupEntity
     */
    public void addEmojiconGroup(CoustomEmojiGroupEntity groupEntity, boolean notifyDataChange) {
     ...
     * @return
     */
    private int getPageSize(CoustomEmojiGroupEntity groupEntity) {
        List<Emojicon> emojiconList = groupEntity.getEmojiconList();
        int itemSize = emojiconColumns * emojiconRows -1;
        int totalSize = emojiconList.size();
        Emojicon.Type emojiType = groupEntity.getType();
