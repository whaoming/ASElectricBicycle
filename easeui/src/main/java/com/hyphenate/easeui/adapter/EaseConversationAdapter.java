...
import com.hyphenate.easeui.widget.CircularImageView;
...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            EaseUserUtils.setUserHead(getContext(), username, holder.avatar);
...
//                            username = user.getNick();
    ...
    public EaseConversationListHelper cvsListHelper;
