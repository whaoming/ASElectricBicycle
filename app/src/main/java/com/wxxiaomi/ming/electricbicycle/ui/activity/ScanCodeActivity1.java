...
import com.wxxiaomi.ming.electricbicycle.view.codeview.decoding.CaptureActivityHandler;
import com.wxxiaomi.ming.electricbicycle.view.codeview.decoding.InactivityTimer;
import com.wxxiaomi.ming.electricbicycle.view.codeview.view.ViewfinderView;

/**
 * Initial the camera
 * @author YunXiang.Tang
 */
public class ScanCodeActivity1 extends Activity implements Callback {
...
//				bundle.putParcelable("bitmap", barcode);
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(ScanCodeActivity1.this, "Scan failed!", Toast.LENGTH_SHORT).show();
		}else {
			Intent resultIntent = new Intent();
			Bundle bundle = new Bundle();
