...
import com.wxxiaomi.ming.electricbicycle.event.EVENT;
import com.wxxiaomi.ming.electricbicycle.event.EventModel;
import com.wxxiaomi.ming.electricbicycle.support.adapter.BaseListAdapter;
import com.wxxiaomi.ming.electricbicycle.ui.view.base.BaseListView;
...
public abstract class BaseListFragment extends BaseFragment implements BaseListView {
    ...
    protected void init() {
        ...
        layoutManager = new LinearLayoutManager(EBApplication.applicationContext);
