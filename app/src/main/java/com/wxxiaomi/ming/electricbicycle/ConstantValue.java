...
//	public static String SERVER_URL = "http://haoming1994.applinzi.com/";
	 ...
	 * 校园网wifi笔记本
	 */
	public static String SERVER_URL = "http://192.168.1.102:8080/ElectricBicycleServer/";

	/**
	 * 登录操作的url
	 */
	public static String OSS_MY_URL = "http://192.168.1.102:8080/OssTokenGetServer/Oss";
