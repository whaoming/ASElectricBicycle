package com.wxxiaomi.ming.electricbicycle.core.weight.em.adapter;
...
import com.wxxiaomi.ming.electricbicycle.core.weight.em.row.MyEaseChatRow2;
import com.wxxiaomi.ming.electricbicycle.core.weight.em.row.MyEaseChatRowText2;
...
public class ChatRowItemAdapter extends RecyclerView.Adapter<ViewHolder> {
	...
	private UserCommonInfo toChatUserInfo;

	public ChatRowItemAdapter(Context context, String username,
			RecyclerView listView,UserCommonInfo toChatUserInfo) {
		super();
