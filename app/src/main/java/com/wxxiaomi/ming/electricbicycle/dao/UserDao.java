...
public interface UserDao {
     ...
     * @return
     */
    Observable<InitUserInfo> getUserListFromWeb(List<String> usernames);
     ...
     * @return
     */
    Observable<NearByPerson> getNearPeople(int userid, double latitude, double longitude);
     ...
     * @return
     */
    Observable<InitUserInfo> getUserCommonInfoByName(String name);
     ...
     * @return
     */
   Observable<Register> registerUser(String username, String password);
