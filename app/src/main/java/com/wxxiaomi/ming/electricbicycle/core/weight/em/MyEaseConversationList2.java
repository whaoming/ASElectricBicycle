...
public class MyEaseConversationList2 extends ListView {
    ...
    protected MyEaseConversationAdapter2 adapter;
    protected List<EMConversation> conversations = new ArrayList<EMConversation>();
    protected List<EMConversation> passedListRef = null;
    
    
    public MyEaseConversationList2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    
    public MyEaseConversationList2(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(List<EMConversation> conversationList){
        ...
        adapter = new MyEaseConversationAdapter2(context,0,conversations);
