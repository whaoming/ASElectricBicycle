...
//            inputMenu.registerExtendMenuItem("红包", R.drawable.em_chat_red_packet_selector, ITEM_RED_PACKET, extendMenuItemClickListener);
//        }
//        //red packet code : 注册转账菜单选项
//        if (chatType == Constant.CHATTYPE_SINGLE) {
//            inputMenu.registerExtendMenuItem("转装", R.drawable.em_chat_transfer_selector, ITEM_TRANSFER_PACKET, extendMenuItemClickListener);
//        }
        //end of red packet code
    }
...
//        startActivity(intent);
        Log.i("wang","点击的头像的username："+username);
    }
