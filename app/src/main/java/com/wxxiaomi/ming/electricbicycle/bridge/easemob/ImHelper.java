package com.wxxiaomi.ming.electricbicycle.bridge.easemob;
...
public class ImHelper {
    ...
    public static final String NOTICE_ARRIVE = TAG+"_messgae_receive";
...
//    }
    ...
    public void openUserCache(List<UserCommonInfo> infos){
        GlobalManager.getInstance().initFriendList(infos);
    }
