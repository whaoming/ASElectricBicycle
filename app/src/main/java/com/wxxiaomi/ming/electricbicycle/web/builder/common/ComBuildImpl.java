package com.wxxiaomi.ming.electricbicycle.web.builder.common;
...
public abstract class ComBuildImpl extends BuilderDetail {
    ...
    public void doFinishEvent(String data) {
        Map<String, String> map = CommonUtil.string2Map(data);
...
//                startActivity(intent);
    ...
    private Observable<String> doGet(String data) {
        Map<String, String> pars = CommonUtil.string2Map(data);
