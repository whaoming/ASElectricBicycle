package com.wxxiaomi.ming.electricbicycle.support;
...
public class Settings {
    ...
    public static final String AVATAR = EBApplication.applicationContext.getString(R.string.id_avatar);
    ...
    public static Settings getsInstance(){
        if (sInstance == null){
            sInstance = new Settings(EBApplication.applicationContext);
        }
        return sInstance;
    }
